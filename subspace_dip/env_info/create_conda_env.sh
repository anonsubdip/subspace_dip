...
pip install hydra-core tensorly==0.6.0 https://github.com/odlgroup/odl/archive/master.zip bios functorch tensorboard backpack-for-pytorch pytorch-minimize
